...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            convert_to_pdf,
            agent::agent_run,
            agent::agent_run_workflow,
            agent::agent_human_resolve,
            agent::agent_create_blueprint,
            agent::agent_list_blueprints,
            agent::agent_delete_blueprint,
            agent::agent_list_experiences,
            // Phase 6.5 + 7: SSOT enforcement + Tool Platform
            agent::agent_test_blueprint,
            agent::agent_publish_blueprint,
            agent::agent_mark_blueprint_tested,
            agent::agent_tool_gap_report,
            agent::agent_list_tools,
            agent::agent_list_tool_policies,
            agent::agent_get_run_replay,
            agent::agent_execution_diff,
            // Phase 2: Revision Candidates + SSOT Consistency + Tool Candidates
            agent::agent_list_revision_candidates,
            agent::agent_review_revision_candidate,
            agent::agent_check_ssot_consistency,
            agent::agent_list_tool_candidates,
            agent::agent_ingest_tool_candidate,
