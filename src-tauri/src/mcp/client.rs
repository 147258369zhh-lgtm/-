...
impl McpClientManager {
    ...
    pub async fn connect_stdio(&self, name: &str, command: &str, args: &[String]) -> Result<(), String> {
        ...
        stdin.write_all(msg_str.as_bytes()).await.map_err(|e| e.to_string())?;
        ...
        clients.insert(name.to_string(), McpClient {
            name: name.to_string(),
            child,
        });
